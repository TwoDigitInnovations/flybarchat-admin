      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-[#141414] border border-primary/30 rounded-2xl p-6 w-full max-w-md shadow-[0_0_25px_rgba(220,38,38,0.3)]"
          >
            {/* Title */}
            ...
            <div className="flex justify-center gap-4">
              ...
              <motion.button
                ...
                className="px-5 py-2 text-md cursor-pointer bg-primary text-white font-semibold rounded-lg hover:shadow-[0_0_15px_#e0f349aa] transition-all duration-200"
              >
                {yesText}
              </motion.button>
            </div>
